...
void DispHex(unsigned int DispData)   // Displays 16 bit number in Hex form using UART2
{
    char i;
    char nib = 0x00;
...
void DispHex32(unsigned long int DispData32)   // Displays 32 bit number in Hex form using UART2
{
    char i;
    char nib = 0x00;
    XmitUART2(' ',1);  // Disp Gap
